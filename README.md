...
**I'm trying to re-train the IER model for tiered-ImageNet but each training is taking 3.75 days (probably more runs to select the best performing model) on 2 A-100 GPUs, I will update ASAP.**
